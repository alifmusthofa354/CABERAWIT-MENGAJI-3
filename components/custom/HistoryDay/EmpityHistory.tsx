...
import NoHistoryIllustration from "@/public/absensibelumada.webp"; // Ganti dengan path ilustrasi Anda
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-4">
          <div className="text-center space-y-3">
            <div className="w-48 h-48  mx-auto">
              ...
              <Image
                src={NoHistoryIllustration} // Pastikan path ini benar
