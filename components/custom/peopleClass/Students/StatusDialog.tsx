...
export default function StatusDialog({
  ...
  const dialogDescription = isActive
    ? `Are you sure you want to deactivate this Student (ID: ${idClass})? It will no longer be active.`
    : `Are you sure you want to activate this Student (ID: ${idClass})? It will become active.`;
